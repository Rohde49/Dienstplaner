...
> = {
  blue: {
    ...
    compactHeaderClass: 'bg-blue-200 text-blue-900',
  ...
  green: {
    ...
    compactHeaderClass: 'bg-green-200 text-green-900',
  ...
  red: {
    ...
    compactHeaderClass: 'bg-red-200 text-red-900',
  ...
  orange: {
    ...
    compactHeaderClass: 'bg-orange-200 text-orange-900',
  ...
  yellow: {
    ...
    compactHeaderClass: 'bg-yellow-200 text-yellow-900',
  ...
  purple: {
    ...
    compactHeaderClass: 'bg-purple-200 text-purple-900',
  ...
  pink: {
    ...
    compactHeaderClass: 'bg-pink-200 text-pink-900',
  ...
  teal: {
    ...
    compactHeaderClass: 'bg-teal-200 text-teal-900',
