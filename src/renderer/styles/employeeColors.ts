...
> = {
  blue: {
    ...
    compactHeaderClass: 'bg-blue-100 text-blue-900',
  ...
  green: {
    ...
    compactHeaderClass: 'bg-green-100 text-green-900',
  ...
  red: {
    ...
    compactHeaderClass: 'bg-red-100 text-red-900',
  ...
  orange: {
    ...
    compactHeaderClass: 'bg-orange-100 text-orange-900',
  ...
  yellow: {
    ...
    compactHeaderClass: 'bg-yellow-100 text-yellow-900',
  ...
  purple: {
    ...
    compactHeaderClass: 'bg-purple-100 text-purple-900',
  ...
  pink: {
    ...
    compactHeaderClass: 'bg-pink-100 text-pink-900',
  ...
  teal: {
    ...
    compactHeaderClass: 'bg-teal-100 text-teal-900',
